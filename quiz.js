...
console.log(blue("\nWelcome To The Famous Game!!!!"));
console.log(yellow("\nHow Well Do You Know About Skin care and treatment!!!"));

var name=r.question(purple("\nEnter Your Name:- "));
console.log(purple("\nWelcome "+name));
console.log("\n! There will be "+ total +" question with 2 to 4 option you can select any one i.e", yellow("1, 2, 3, 4"), "!\n");
